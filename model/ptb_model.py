...
class SignalCNN(nn.Module):
    def __init__(self, input_channels, num_classes=32):
...
class ConvNet(nn.Module):
    def __init__(self, in_channels=1):
        ...
        self.conv1 = nn.Conv1d(in_channels=in_channels, out_channels=16, kernel_size=5)
...
class PTBModel(BaseModel):
    def __init__(self, num_classes = 5, in_channels=1):
        super().__init__()
        #self.flatten = nn.Flatten()
        self.convnet =  SignalCNN(in_channels)# ConvNet(in_channels)
        
        #self.mlp = AttentionClassifier(mlp_input_size, num_classes)
        self.mlp = MLPClassifier(input_size=32, output_size=num_classes)#AttentionClassifier(mlp_input_size, num_classes)
